...
{{-- page title --}}
@section('title', $hnh->language()->title)
                ...
                <div class="display-flex media">
                    <div class="media-body">
                        <h6 class="media-heading">
                            <span class="users-view-name">{{$hnh->language()->title}} </span>
                        </h6>
                    </div>
                </div>
            </div>
            <div class="col s12 m5 quick-action-btns display-flex justify-content-end align-items-center pt-2">
                <a href="{{locale_route('hnh.edit',$hnh->id)}}" class="btn-small indigo">
                    @lang('admin.edit')
                </a>
                ...
                <div class="col s12 m4">
                    <table class="striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{locale_route('category.show',$hnh->category_id)}}">
...
{{--                        </tr>--}}
                        ...
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($hnh->created_at)}}</td>
                        </tr>
                        <tr>
                            <td>@lang('admin.updated_at')</td>
                            <td>{{\Carbon\Carbon::parse($hnh->updated_at)}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
